...
void pbma_read ( char *file_in_name, int *xsize, int *ysize,int *spectrum, int **barrary );
...
void pbma_write ( char *file_out_name, int xsize, int ysize, int spectrum, int *barray );
